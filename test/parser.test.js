...
const syntaxChecks = [
  ["simplest syntactically correct program", "print x"],
  ["multiple statements", "print 1 \nprint 2 \nprint 3"],
  ["variable declarations", "let e=99*1 \nlet z=false"],
  ["function with no params, no return type", "define f() then return 0"],
  ["function with one param", "define f(x) then return x"],
  ["function with two params", "define f(x, y) then return x*y"],
